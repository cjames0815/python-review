...
#with curly braces, separated by a comma or by using the dict
#function. Values in a dictionary can be any data type and 
...
#These line of code are accessing an element value in
...
# the Python lrn function tells the number of elements in a dictionary.
print(len(nums))

# The line of code id creating a dictionary of mixed values.
